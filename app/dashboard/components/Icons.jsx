...
export function SwitchIcon({ className = "w-4 h-4" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function SparklesIcon({ className = "w-4 h-4" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path d="M12 2L14.09 8.26L20.18 9L15.59 13.14L17.18 19.27L12 16L6.82 19.27L8.41 13.14L3.82 9L9.91 8.26L12 2Z" />
    </svg>
  );
}
...
export function AccessibilityIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <path d="M5 8h14M9 8v8M15 8v4l2 4M9 16l2 4" />
    </svg>
  );
}
...
export function getNavIcon(icon, className) {
